...
$languageStrings = array(
 ...
 //Convert Lead
	...
	'LBL_FOLLOWING_ARE_POSSIBLE_REASONS' => '以下の原因が考えられます：',
	'LBL_LEADS_FIELD_MAPPING_INCOMPLETE' => 'すべての必須フィールドがマップされていない',
	'LBL_MANDATORY_FIELDS_ARE_EMPTY' => '必須フィールド値のいくつかは空である',
	'LBL_LEADS_FIELD_MAPPING' => '見込み客のカスタム フィールド マッピング',

 //Leads Custom Field Mapping
	'LBL_CUSTOM_FIELD_MAPPING'=> 'カスタムフィールド マッピングの編集',
	'LBL_WEBFORMS' => 'Web フォーム のセットアップ',
);
