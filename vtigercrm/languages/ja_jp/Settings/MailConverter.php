...
$languageStrings = array(
	...
	'LBL_ADDING_NEW_MAILBOX' => '新規メールボックス追加中',
	'MAILBOX_DETAILS' => 'メールボックス 詳細',
	'SELECT_FOLDERS' => 'フォルダの選択',
	'ADD_RULES' => 'ルールの追加',
	'CREATE_Leads_SUBJECT' => '見込み客の作成',
	...
	'LBL_MAILCONVERTER_DESCRIPTION' => 'メールコンバーターは電子メールをスキャンするメールボックスを設定して、Vtiger CRMで適切なエンティティを作成することができます。また、メールにどの操作が実行されるべきかを指定するために、ルールを定義する必要があります。<br />スケジューラでメールスキャナの実行を無効にしていない限り、電子メールは自動的にスキャンされます。<br /><br /><br />',
 ...
 //Rule Actions
    ...
    'LINK_Leads_FROM' => '見込み客に追加[送信者]',
    'LINK_Leads_TO' => '見込み客に追加[宛先]',
