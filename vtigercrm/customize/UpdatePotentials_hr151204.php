...
$blockInstance = $blockInstance->getInstance(131);  #ヨミ案件のHR

#流用区分
$field = new Vtiger_Field();
$field->name = 'diversion_kubun';  #fieldname 日本語ダメ
$field->table = $module->basetable; #vtiger_potential
$field->column = 'diversion_kubun'; #入力フォームの項目名(columnname, fieldLabel)日本語ダメ
$field->columntype =  'VARCHAR(255)';
$field->uitype = 15;  #15はリスト型
$field->displaytype= 1;
$field->label = $field->column;
$blockInstance->addField($field);
$field->setPicklistValues( array ('test')); #リストの項目を追加する
