...
// transport classes
require_once('class.wf_soap_transport_http.php');
...
//$GLOBALS['_transient']['static']['wf_nusoap_base']['globalDebugLevel'] = 9;
...
class wf_nusoap_base {
	...
	* @access	public
	*/
	function wf_nusoap_base() {
		$this->debugLevel = $GLOBALS['_transient']['static']['wf_nusoap_base']['globalDebugLevel'];
	}
	...
	*/
	function getGlobalDebugLevel() {
		return $GLOBALS['_transient']['static']['wf_nusoap_base']['globalDebugLevel'];
	}
	...
	*/
	function setGlobalDebugLevel($level) {
		$GLOBALS['_transient']['static']['wf_nusoap_base']['globalDebugLevel'] = $level;
	}
...
* @access public
*/
class nusoap_fault extends wf_nusoap_base {
	/**
...
* @access   public
*/
class nusoap_xmlschema extends wf_nusoap_base  {
...
class soapval extends wf_nusoap_base {
	/**
...
* @access public
*/
class wf_soap_transport_http extends wf_nusoap_base {
	...
	* @access public
	*/
	function wf_soap_transport_http($url, $curl_options = NULL, $use_curl = false){
		parent::wf_nusoap_base();
...
* @access   public
*/
class nusoap_server extends wf_nusoap_base {
	/**
...
* @access public 
*/
class wf_wsdl extends wf_nusoap_base {
    ...
    function parseWSDL($wsdl = '') {
        ...
        if (isset($wsdl_props['scheme']) && ($wsdl_props['scheme'] == 'http' || $wsdl_props['scheme'] == 'https')) {
        	...
        	// get wsdl
	        $tr = new wf_soap_transport_http($wsdl, $this->curl_options, $this->use_curl);
...
* @access   public
*/
class nusoap_parser extends wf_nusoap_base {
...
* @access   public
*/
class wf_nusoap_client extends wf_nusoap_base  {
	...
	* @access   public
	*/
	function wf_nusoap_client($endpoint,$wsdl = false,$proxyhost = false,$proxyport = false,$proxyusername = false, $proxypassword = false, $timeout = 0, $response_timeout = 30, $portName = ''){
		parent::wf_nusoap_base();
	...
	*/
	...
	function loadWSDL() {
		...
		$this->wsdl = new wf_wsdl('',$this->proxyhost,$this->proxyport,$this->proxyusername,$this->proxypassword,$this->timeout,$this->response_timeout,$this->curl_options,$this->use_curl);
		...
		switch(true){
			...
			case preg_match('/^http/',$this->endpoint):
				...
				if($this->persistentConnection == true && is_object($this->persistentConnection)){
					...
					$http = new wf_soap_transport_http($this->endpoint, $this->curl_options, $this->use_curl);
					if ($this->persistentConnection) {
...
if (!extension_loaded('soap')) {
	 ...
	 */
	class soapclient extends wf_nusoap_client {
	}
}
?>
