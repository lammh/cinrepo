...
class Records extends \Workflow\Fieldtype
{
    ...
    public function renderFrontend($data, $context) {
        ...
        $objMySQL = new \Workflow\ConditionMysql($conditions['module'], $context);
        $objMySQL->setLogger($logger);

        $main_module = \CRMEntity::getInstance($conditions['module']);
        ...
        $mainData = \Workflow\VtUtils::getMainRecordData($conditions['module'], $ids);
