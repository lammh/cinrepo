...
class Contact extends \Workflow\Fieldtype
{
    ...
    public function renderFrontend($data, $context) {
        ...
        $field1 = '<div class="insertReferencefield" style="float:right;" data-name="'.$data['name'].'_accountid"></div>';
        $field2 = '<div class="insertReferencefield" style="float:right;" data-name="'.$data['name'].'_contactid"></div>';
