...
class Documents extends \Workflow\Attachment {
    ...
    public function getConfigurations($moduleName) {
        $configuration = array(
            'html' => '<a href="#" onclick="attachCRMDocument(); ">Select Documents to attach</a>',
            'script' => "
