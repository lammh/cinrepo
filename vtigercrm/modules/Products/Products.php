...
class Products extends CRMEntity {
	...
	function save_module($module)
	{
		...
		#if($_POST[record] == true && $_POST[seo_keyword] == true && $_POST[seo_url] == true && registCheck($_POST[record])) {
		#	keywordRegist($_POST[record]);
		#}//End if
		//■2015/07/21 mod ohkuma JAS　rank_keyword rank_feeへのInsertとUpdate -----------------------------------------------------------------▲
	...
	/* ▼ 大熊追加(20150903) ***********/
	function jas_save($module, $productid) {
		require_once('cin/Products/jasSave.php');
	}//End function
	/* ▲ 大熊追加(20150903)  ***********/
