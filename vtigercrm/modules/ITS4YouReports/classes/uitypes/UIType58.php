    ...
    public function getStJoinSQL(&$join_array, &$columns_array) {
        if (isset($this->params["fieldid"]) && $this->params["fieldid"] != "") {
            ...
            if (!array_key_exists(" vtiger_campaign AS vtiger_campaign" . $fieldid_alias . " ", $join_array)) {
                ...
                $join_array[" vtiger_campaign AS vtiger_campaign" . $fieldid_alias . " "]["using"] = $tablename . $old_oth_fieldid . $mif_as . "." . $columnname;
            }
            if (!array_key_exists(" vtiger_crmentity AS vtiger_crmentity".$this->oth_as . $fieldid_alias . " ", $join_array)) {
                ...
                $join_array[" vtiger_crmentity AS vtiger_crmentity".$this->oth_as . $fieldid_alias . " "]["using"] = "vtiger_campaign" . $fieldid_alias . ".campaignid AND vtiger_crmentity".$this->oth_as . $fieldid_alias . ".deleted=0 ";
            }
        }
    }
...
//show("<font color='green'>fielduitype58_IN_P_".$field_uitype,$related_join_array,$params["using_array"],"</font>");
