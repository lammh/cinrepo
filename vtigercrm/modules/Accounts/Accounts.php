...
class Accounts extends CRMEntity {
	...
	/* ▼ 大熊追加(20150907) ***********/
	function jas_save($module, $accountid) {
		require_once('cin/Accounts/jasSave.php');
	}//End function
	/* ▲ 大熊追加(20150907)  ***********/
	...
	*/
	...
	function transferRelatedRecords($module, $transferEntityIds, $entityId) {
		...
		$log->debug("Exting function transferRelatedRecords ($module, $transferEntityIds, $entityId)");
	}
	...
	function setRelationTables($secmodule){ 
        global $log;
        $log->debug("Entering setRelationTables(".$secmodule.") method ...");
        $rel_tables =  array (
		...
		$log->debug("Exiting setRelationTables(".$secmodule.") ...");
	...
	function generateReportsSecQuery($module,$secmodule,$queryPlanner){
		...
		$log->debug("Entering generateReportsSecQuery(".$module.",".$secmodule.",".$queryPlanner.") method ...");
		...
		if (!$queryPlanner->requireTable('vtiger_account', $matrix)) {
            $log->debug("Exiting generateReportsSecQuery(".$module.",".$secmodule.",".$queryPlanner.") method ...");
            return '';
		}
	...
	*/
	...
	function unlinkDependencies($module, $id) {
        ...
        $log->debug("Entering unlinkDependencies(".$module.",".$id.") method ...");
        ...
        $log->debug("Exiting unlinkDependencies(".$module.",".$id.") method ...");
	}
	...
	function unlinkRelationship($id, $return_module, $return_id) {
        ...
        $log->debug("Entering unlinkRelationship(".$id.",".$return_module.",".$return_id.") method ...");
        ...
        $log->debug("Exiting unlinkRelationship(".$id.",".$return_module.",".$return_id.") method ...");
	}
	...
	function getListButtons($app_strings,$mod_strings = false) {
		...
		$log->debug("Entering getListButtons(".$app_strings.",".$mod_strings.") method ...");
		$list_buttons = Array();
		...
		$log->debug("Exint getListButtons(".$app_strings.",".$mod_strings.") method ...");
		return $list_buttons;
	}
	...
	function get_attachments($id, $cur_tab_id, $rel_tab_id, $actions = false) {
		global $log, $currentModule, $app_strings, $singlepane_view;

		$log->debug("Entering get_attachments(".$id.",".$cur_tab_id.",".$rel_tab_id.",".$actions.") method ...");
		$this_module = $currentModule;
		$parenttab = getParentTab();
		...
		if ($return_value == null)
			$return_value = Array();
		$return_value['CUSTOM_BUTTON'] = $button;
		$log->debug("Exiting get_attachments(".$id.",".$cur_tab_id.",".$rel_tab_id.",".$actions.") method ...");
		return $return_value;
	}
	...
	function get_dependents_list($id, $cur_tab_id, $rel_tab_id, $actions = false) {
		global $log, $currentModule, $app_strings, $singlepane_view, $current_user;

		$log->debug("Entering get_dependents_list(".$id.",".$cur_tab_id.",".$rel_tab_id.",".$actions.") method ...");
		$parenttab = getParentTab();
		...
		if ($return_value == null)
			$return_value = Array();
		$return_value['CUSTOM_BUTTON'] = $button;
		$log->debug("Exiting get_dependents_list(".$id.",".$cur_tab_id.",".$rel_tab_id.",".$actions.") method ...");
		return $return_value;
	}
