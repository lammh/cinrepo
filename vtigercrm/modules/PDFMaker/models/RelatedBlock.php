...
class PDFMaker_RelatedBlock_Model extends Vtiger_Module_Model {
    ...
    /**
     * Function sets the Primary Module of the Related Block
     * @param <String> $module
     */
    ...
    /**
     * Function sets the Secondary Modules for the Related Block
    ...
    /**
     * Function returns Primary Module of the Related Block
     * @return <String>
     */
    ...
    /**
     * Function returns Secondary Module of the Related Block
     * @return <String>
     */
