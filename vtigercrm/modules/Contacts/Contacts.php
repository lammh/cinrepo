  ...
  $log->debug("Exiting get_contactsforol method ...");
	...
	*/
	function save_module($module)
	{
		...
		//■2015/07/21 mod ohkuma JAS　rank_charger_mas へのInsertとUpdate -----------------------------------------------------------------▼
		//#vtiger_contactdetailsのcontactidをrank_charger_masに追加する
		//require_once("./cin/registChargerMas.php");
		//■2015/07/21 mod ohkuma JAS　rank_charger_mas へのInsertとUpdate -----------------------------------------------------------------▲
	...
	/* ▼ 大熊追加(20150903) ***********/
	function jas_save($module, $contactid) {
		require_once('cin/Contacts/jasSave.php');
	}//End function
	/* ▲ 大熊追加(20150903)  ***********/
