...
global $log;
$log->debug("Entering ./views/Popup.php::getModule");
		$moduleName = $request->getModule();
		return $moduleName;
	}
...
global $log;
$log->debug("Entering ./views/Popup.php::process");
...
global $log;
$log->debug("Entering ./views/Popup.php::postProcess");
		$viewer = $this->getViewer ($request);
		$moduleName = $this->getModule($request);
...
global $log;
$log->debug("Entering ./views/Popup.php::initializeListViewContents");
		$moduleName = $this->getModule($request);
...
global $log;
$log->debug("Entering ./views/Popup.php::getListViewCount");
		$moduleName = $this->getModule($request);
		$sourceModule = $request->get('src_module');
		$sourceField = $request->get('src_field');
		$sourceRecord = $request->get('src_record');
...
global $log;
$log->debug("Entering ./views/Popup.php::getPageCount");
