...
global $log;
$log->debug("Entering ./views/ComposeEmail.php::checkPermission");
...
global $log;
$log->debug("Entering ./views/ComposeEmail.php::preProcess");
...
global $log;
$log->debug("Entering ./views/ComposeEmail.php::composeMailData");
		$moduleName = 'Emails';
...
global $log;
$log->debug("Entering ./views/ComposeEmail.php::emailActionsData");
...
global $log;
$log->debug("Entering ./views/ComposeEmail.php::process");
...
global $log;
$log->debug("Entering ./views/ComposeEmail.php::postProcess");
		return;
	}
...
global $log;
$log->debug("Entering ./views/ComposeEmail.php::emailPreview");
		$recordId = $request->get('record');
		$moduleName = $request->getModule();
...
global $log;
$log->debug("Entering ./views/ComposeEmail.php::emailEdit");
		$viewer = $this->getViewer($request);
...
global $log;
$log->debug("Entering ./views/ComposeEmail.php::emailForward");
		$viewer = $this->getViewer($request);
		$moduleName = $request->getModule();
		$this->emailActionsData($request);
		$viewer->assign('TO', '');
...
global $log;
$log->debug("Entering ./views/ComposeEmail.php::previewPrint");
