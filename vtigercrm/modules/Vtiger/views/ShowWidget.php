...
global $log;
$log->debug("Entering ./views/ShowWidget.php::checkPermission");
		return true;
	}
...
global $log;
$log->debug("Entering ./views/ShowWidget.php::process");
...
global $log;
$log->debug("Entering ./views/ShowWidget.php::validateRequest");
