...
global $log;
$log->debug("Entering ./views/UI5Embed.php::preProcessDisplay");
	
	protected function getUI5EmbedURL(Vtiger_Request $request) {

global $log;
$log->debug("Entering ./views/UI5Embed.php::getUI5EmbedURL");
...
global $log;
$log->debug("Entering ./views/UI5Embed.php::process");
