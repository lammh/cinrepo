...
global $log;
$log->debug("Entering ./views/FindDuplicates.php::preProcess");
...
global $log;
$log->debug("Entering ./views/FindDuplicates.php::preProcessTplName");
...
global $log;
$log->debug("Entering ./views/FindDuplicates.php::process");
		$viewer = $this->getViewer ($request);
...
global $log;
$log->debug("Entering ./views/FindDuplicates.php::getRecordsCount");
		$moduleName = $request->getModule();
		$duplicateSearchFields = $request->get('fields');
