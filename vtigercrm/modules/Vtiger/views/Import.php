...
global $log;
$log->debug("Entering ./views/Import.php::checkPermission");
...
global $log;
$log->debug("Entering ./views/Import.php::process");
...
global $log;
$log->debug("Entering ./views/Import.php::importBasicStep");
...
global $log;
$log->debug("Entering ./views/Import.php::uploadAndParse");
...
global $log;
$log->debug("Entering ./views/Import.php::import");
		$user = Users_Record_Model::getCurrentUserModel();
...
global $log;
$log->debug("Entering ./views/Import.php::undoImport");
...
global $log;
$log->debug("Entering ./views/Import.php::lastImportedRecords");
...
global $log;
$log->debug("Entering ./views/Import.php::deleteMap");
...
global $log;
$log->debug("Entering ./views/Import.php::clearCorruptedData");
		$user = Users_Record_Model::getCurrentUserModel();
...
global $log;
$log->debug("Entering ./views/Import.php::cancelImport");
...
global $log;
$log->debug("Entering ./views/Import.php::checkImportStatus");
		$moduleName = $request->getModule();
		$user = Users_Record_Model::getCurrentUserModel();
		$mode = $request->getMode();
