...
global $log;
$log->debug("Entering ./views/TooltipAjax.php::preProcess");
		return true;
	}
...
global $log;
$log->debug("Entering ./views/TooltipAjax.php::postProcess");
		return true;
	}
...
global $log;
$log->debug("Entering ./views/TooltipAjax.php::process");
...
global $log;
$log->debug("Entering ./views/TooltipAjax.php::initializeListViewContents");
