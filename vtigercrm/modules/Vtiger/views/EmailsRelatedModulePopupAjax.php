...
global $log;
$log->debug("Entering ./views/EmailsRelatedModulePopupAjax.php::preProcess");
		return true;
	}
...
global $log;
$log->debug("Entering ./views/EmailsRelatedModulePopupAjax.php::postProcess");
		return true;
	}
...
global $log;
$log->debug("Entering ./views/EmailsRelatedModulePopupAjax.php::process");
