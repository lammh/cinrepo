...
global $log;
$log->debug("Entering ./views/MassActionAjax.php::process");
...
global $log;
$log->debug("Entering ./views/MassActionAjax.php::showAddCommentForm");
...
global $log;
$log->debug("Entering ./views/MassActionAjax.php::showComposeEmailForm");
		$moduleName = 'Emails';
		$sourceModule = $request->getModule();
		$cvId = $request->get('viewname');
		$selectedIds = $request->get('selected_ids');
...
global $log;
$log->debug("Entering ./views/MassActionAjax.php::showSendSMSForm");
...
global $log;
$log->debug("Entering ./views/MassActionAjax.php::getRecordsListFromRequest");
		$cvId = $request->get('viewname');
		$selectedIds = $request->get('selected_ids');
		$excludedIds = $request->get('excluded_ids');
        if(empty($module)) {
...
global $log;
$log->debug("Entering ./views/MassActionAjax.php::showMailMergeTemplates");
		$selectedIds = $request->get('selected_ids');
		$excludedIds = $request->get('excluded_ids');
		$cvId = $request->get('viewname');
		$module = $request->getModule();
...
global $log;
$log->debug("Entering ./views/MassActionAjax.php::showDuplicatesSearchForm");
		$module = $request->getModule();
...
global $log;
$log->debug("Entering ./views/MassActionAjax.php::transferOwnership");
		$module = $request->getModule();
		$moduleModel = Vtiger_Module_Model::getInstance($module);
