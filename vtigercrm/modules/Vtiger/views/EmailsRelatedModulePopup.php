...
global $log;
$log->debug("Entering ./views/EmailsRelatedModulePopup.php::checkPermission");
...
global $log;
$log->debug("Entering ./views/EmailsRelatedModulePopup.php::initializeListViewContents");
...
global $log;
$log->debug("Entering ./views/EmailsRelatedModulePopup.php::getHeaderScripts");
