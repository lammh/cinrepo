...
global $log;
$log->debug("Entering ./views/IndexAjax.php::preProcess");
		return true;
	}
...
global $log;
$log->debug("Entering ./views/IndexAjax.php::postProcess");
		return true;
	}
...
global $log;
$log->debug("Entering ./views/IndexAjax.php::process");
...
global $log;
$log->debug("Entering ./views/IndexAjax.php::showActiveRecords");
