...
global $log;
$log->debug("Entering ./views/DashBoard.php::preProcessTplName");
...
global $log;
$log->debug("Entering ./views/DashBoard.php::postProcess");
...
global $log;
$log->debug("Entering ./views/DashBoard.php::getHeaderScripts");
...
global $log;
$log->debug("Entering ./views/DashBoard.php::getHeaderCss");
