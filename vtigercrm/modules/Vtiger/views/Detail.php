...
class Vtiger_Detail_View extends Vtiger_Index_View {
	...
	function checkPermission(Vtiger_Request $request) {
        ...
        global $log;
        $log->debug("Entering Vtiger/views/Detail.php::checkPermission");
   	...
   	function preProcess(Vtiger_Request $request, $display=true) {
        global $log;
        $log->debug("Entering Vtiger/views/Detail.php::preProcess");
	...
	function preProcessTplName(Vtiger_Request $request) {
        global $log;
        $log->debug("Entering Vtiger/views/Detail.php::preProcessTplName");
		return 'DetailViewPreProcess.tpl';
	}

	function process(Vtiger_Request $request) {
        global $log;
        $log->debug("Entering Vtiger/views/Detail.php::process");
	...
	public function postProcess(Vtiger_Request $request) {
        global $log;
        $log->debug("Entering Vtiger/views/Detail.php::postProcess");
		$recordId = $request->get('record');
		$moduleName = $request->getModule();
		$currentUserModel = Users_Record_Model::getCurrentUserModel();
		$moduleModel = Vtiger_Module_Model::getInstance($moduleName);
...
//		$viewer->assign('DETAILVIEW_LINKS', $detailViewLinks);
	...
	public function getHeaderScripts(Vtiger_Request $request) {
        ...
        global $log;
        $log->debug("Entering Vtiger/views/Detail.php::getHeaderScripts");
	...
	function showDetailViewByMode($request) {
        ...
        global $log;
        $log->debug("Entering Vtiger/views/Detail.php::showDetailViewByMode");
	...
	function showModuleDetailView(Vtiger_Request $request) {
        ...
        global $log;
        $log->debug("Entering Vtiger/views/Detail.php::showModuleDetailView");
		$recordId = $request->get('record');
		$moduleName = $request->getModule();
	...
	function showModuleSummaryView($request) {
        ...
        global $log;
        $log->debug("Entering Vtiger/views/Detail.php::showModuleSummaryView");
		$recordId = $request->get('record');
		$moduleName = $request->getModule();
...
//		$viewer->assign('DETAILVIEW_LINKS', $detailViewLinks);
	...
	function showRecentActivities (Vtiger_Request $request) {
        ...
        global $log;
        $log->debug("Entering Vtiger/views/Detail.php::showRecentActivities");
	...
	function showRecentComments(Vtiger_Request $request) {
        ...
        global $log;
        $log->debug("Entering Vtiger/views/Detail.php::showRecentComments");
	...
	function showRelatedList(Vtiger_Request $request) {
        global $log;
        $log->debug("Entering Vtiger/views/Detail.php::showRelatedList");
		$moduleName = $request->getModule();
	...
	function showChildComments(Vtiger_Request $request) {
        global $log;
        $log->debug("Entering Vtiger/views/Detail.php::showChildComments");
	...
	function showAllComments(Vtiger_Request $request) {
        global $log;
        $log->debug("Entering Vtiger/views/Detail.php::showAllComments");
        $parentRecordId = $request->get('record');
	...
	function isAjaxEnabled($recordModel) {
        global $log;
        $log->debug("Entering Vtiger/views/Detail.php::isAjaxEnabled");
	...
	public function getActivities(Vtiger_Request $request) {
        global $log;
        $log->debug("Entering Vtiger/views/Detail.php::getActivities");
		return '';
	}
	...
	function showRelatedRecords(Vtiger_Request $request) {
        ...
        global $log;
        $log->debug("Entering Vtiger/views/Detail.php::showRelatedRecords");
		$parentId = $request->get('record');
		$pageNumber = $request->get('page');
		$limit = $request->get('limit');
		$relatedModuleName = $request->get('relatedModule');
