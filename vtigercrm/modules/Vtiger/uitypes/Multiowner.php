...
global $log;
$log->debug("Entering ./uitypes/Multiowner.php::getTemplateName");
...
global $log;
$log->debug("Entering ./uitypes/Multiowner.php::getDisplayValue");
...
global $log;
$log->debug("Entering ./uitypes/Multiowner.php::staticgetOwnerType");
