...
global $log;
$log->debug("Entering ./uitypes/Time.php::getTemplateName");
...
global $log;
$log->debug("Entering ./uitypes/Time.php::staticgetTimeValueInAMorPM");
		if($time){
...
global $log;
$log->debug("Entering ./uitypes/Time.php::staticgetTimeValueWithSeconds");
		if($time){
...
global $log;
$log->debug("Entering ./uitypes/Time.php::getEditViewDisplayValue");
		return self::getTimeValueInAMorPM($value);
	}
...
global $log;
$log->debug("Entering ./uitypes/Time.php::getListSearchTemplateName");
