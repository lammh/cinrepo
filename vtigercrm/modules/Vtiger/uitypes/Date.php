...
global $log;
$log->debug("Entering ./uitypes/Date.php::getTemplateName");
...
global $log;
$log->debug("Entering ./uitypes/Date.php::getDisplayValue");
		if(empty($value)){
			return $value;
		} else {
...
global $log;
$log->debug("Entering ./uitypes/Date.php::getUserRequestValue");
...
global $log;
$log->debug("Entering ./uitypes/Date.php::getDBInsertValue");
...
global $log;
$log->debug("Entering ./uitypes/Date.php::staticgetDBInsertedValue");
...
global $log;
$log->debug("Entering ./uitypes/Date.php::getEditViewDisplayValue");
...
global $log;
$log->debug("Entering ./uitypes/Date.php::staticgetDisplayDateValue");
...
global $log;
$log->debug("Entering ./uitypes/Date.php::staticgetDisplayDateTimeValue");
...
global $log;
$log->debug("Entering ./uitypes/Date.php::getListSearchTemplateName");
