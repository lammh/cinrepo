...
global $log;
$log->debug("Entering ./uitypes/Currency.php::getTemplateName");
...
global $log;
$log->debug("Entering ./uitypes/Currency.php::getDisplayValue");
...
global $log;
$log->debug("Entering ./uitypes/Currency.php::getUserRequestValue");
...
global $log;
$log->debug("Entering ./uitypes/Currency.php::getDBInsertValue");
        $uiType = $this->get('field')->get('uitype');
        if($uiType == 72) {
...
global $log;
$log->debug("Entering ./uitypes/Currency.php::getEditViewDisplayValue");
		if(!empty($value))
			return $this->getDisplayValue($value);
        return $value;
	}
