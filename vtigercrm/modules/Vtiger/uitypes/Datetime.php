...
global $log;
$log->debug("Entering ./uitypes/Datetime.php::getTemplateName");
...
global $log;
$log->debug("Entering ./uitypes/Datetime.php::getDisplayValue");
...
global $log;
$log->debug("Entering ./uitypes/Datetime.php::staticgetDisplayDateTimeValue");
