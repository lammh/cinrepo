...
global $log;
$log->debug("Entering ./uitypes/Base.php::getTemplateName");
...
global $log;
$log->debug("Entering ./uitypes/Base.php::getDBInsertValue");
		return $value;
	}
...
global $log;
$log->debug("Entering ./uitypes/Base.php::getUserRequestValue");
		return $value;
	}
...
global $log;
$log->debug("Entering ./uitypes/Base.php::getDisplayValue");
		return $value;
	}
...
global $log;
$log->debug("Entering ./uitypes/Base.php::staticgetInstanceFromField");
...
global $log;
$log->debug("Entering ./uitypes/Base.php::getEditViewDisplayValue");
		return $value;
	}
...
global $log;
$log->debug("Entering ./uitypes/Base.php::getDetailViewTemplateName");
...
global $log;
$log->debug("Entering ./uitypes/Base.php::getRelatedListDisplayValue");
...
global $log;
$log->debug("Entering ./uitypes/Base.php::getListSearchTemplateName");
