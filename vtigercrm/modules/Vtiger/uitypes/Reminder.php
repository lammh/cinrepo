...
global $log;
$log->debug("Entering ./uitypes/Reminder.php::getTemplateName");
...
global $log;
$log->debug("Entering ./uitypes/Reminder.php::getDetailViewTemplateName");
...
global $log;
$log->debug("Entering ./uitypes/Reminder.php::getDisplayValue");
        $reminder_value = '';
...
global $log;
$log->debug("Entering ./uitypes/Reminder.php::getEditViewDisplayValue");
		if($value != 0 ){
