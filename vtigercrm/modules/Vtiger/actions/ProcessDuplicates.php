...
global $log;
$log->debug("Entering ./actions/ProcessDuplicates.php::checkPermission");
...
global $log;
$log->debug("Entering ./actions/ProcessDuplicates.php::process");
...
global $log;
$log->debug("Entering ./actions/ProcessDuplicates.php::validateRequest");
