...
global $log;
$log->debug("Entering ./actions/NoteBook.php::__construct");
...
global $log;
$log->debug("Entering ./actions/NoteBook.php::NoteBookCreate");
...
global $log;
$log->debug("Entering ./actions/NoteBook.php::validateRequest");
