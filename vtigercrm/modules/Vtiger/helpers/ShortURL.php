...
global $log;
$log->debug("Entering ./helpers/ShortURL.php::staticgenerateURL");
        global $site_URL;
...
global $log;
$log->debug("Entering ./helpers/ShortURL.php::staticgenerate");
...
global $log;
$log->debug("Entering ./helpers/ShortURL.php::statichandle");
        $db = PearDatabase::getInstance();
...
global $log;
$log->debug("Entering ./helpers/ShortURL.php::staticsendTrackerImage");
...
global $log;
$log->debug("Entering ./helpers/ShortURL.php::getInstance");
        $db = PearDatabase::getInstance();
        $self = new self();
...
global $log;
$log->debug("Entering ./helpers/ShortURL.php::compareEquals");
        $valid = true;
...
global $log;
$log->debug("Entering ./helpers/ShortURL.php::delete");
        $db = PearDatabase::getInstance();
