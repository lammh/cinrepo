...
global $log;
$log->debug("Entering ./models/DashBoard.php::getModule");
		return $this->module;
	}
...
global $log;
$log->debug("Entering ./models/DashBoard.php::setModule");
...
global $log;
$log->debug("Entering ./models/DashBoard.php::getModuleName");
...
global $log;
$log->debug("Entering ./models/DashBoard.php::getSelectableDashboard");
...
global $log;
$log->debug("Entering ./models/DashBoard.php::getDashboards");
...
global $log;
$log->debug("Entering ./models/DashBoard.php::getDefaultWidgets");
...
global $log;
$log->debug("Entering ./models/DashBoard.php::checkModulePermission");
        $currentUserPrivilegeModel = Users_Privileges_Model::getCurrentUserPrivilegesModel();
...
global $log;
$log->debug("Entering ./models/DashBoard.php::getModuleNameFromLink");
