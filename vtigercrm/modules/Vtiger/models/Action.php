...
class Vtiger_Action_Model extends Vtiger_Base_Model {
	...
	public function isModuleEnabled($module) {
        ...
        $log->debug("Entering Vtiger_Action_Model::isModuleEnabled(".$module.") module ...");
		...
		if($result && $db->num_rows($result) > 0) {
            $log->debug("Exiting Vtiger_Action_Model::isModuleEnabled(".$module.") module ...");
			return true;
		}
        $log->debug("Exiting Vtiger_Action_Model::isModuleEnabled(".$module.") module ...");
		return false;
	...
	public static function getAllBasic($configurable=false) {
        ...
        $log->debug("Entering Vtiger_Action_Model::getAllBasic(".$configurable.") method ...");
		$db = PearDatabase::getInstance();
        ...
        $log->debug("Exiting Vtiger_Action_Model::getAllBasic(".$configurable.") method ...");
		return $actionModels;
	}
	...
	public static function getAllUtility($configurable=false) {
        ...
        $log->debug("Entering Vtiger_Action_Model::getAllUtility(".$configurable.") method ...");
		$db = PearDatabase::getInstance();
		$basicActionIds = array_keys(self::$standardActions);
        ...
        $log->debug("Exiting Vtiger_Action_Model::getAllUtility(".$configurable.") method ...");
		return $actionModels;
	}
}
