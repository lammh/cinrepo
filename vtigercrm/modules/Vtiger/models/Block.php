...
global $log;
$log->debug("Entering ./models/Block.php::setFields");
...
global $log;
$log->debug("Entering ./models/Block.php::get");
...
global $log;
$log->debug("Entering ./models/Block.php::set");
        if(property_exists($this,$propertyName)){
...
global $log;
$log->debug("Entering ./models/Block.php::isCustomized");
...
global $log;
$log->debug("Entering ./models/Block.php::__update");
...
global $log;
$log->debug("Entering ./models/Block.php::isHidden");
...
global $log;
$log->debug("Entering ./models/Block.php::getInActiveFields");
...
global $log;
$log->debug("Entering ./models/Block.php::staticgetInstance");
...
global $log;
$log->debug("Entering ./models/Block.php::staticgetInstanceFromBlockObject");
...
global $log;
$log->debug("Entering ./models/Block.php::staticupdateSequenceNumber");
        $db = PearDatabase::getInstance();
...
global $log;
$log->debug("Entering ./models/Block.php::staticcheckFieldsExists");
        $db = PearDatabase::getInstance();
...
global $log;
$log->debug("Entering ./models/Block.php::staticpushDown");
		$db = PearDatabase::getInstance();
...
global $log;
$log->debug("Entering ./models/Block.php::staticgetAllBlockSequenceList");
        $db = PearDatabase::getInstance();
...
global $log;
$log->debug("Entering ./models/Block.php::staticcheckDuplicate");
		$db = PearDatabase::getInstance();
