...
class Vtiger_Module_Model extends Vtiger_Module {
	...
	public function isCommentEnabled() {
        ...
        $log->debug("Entering ./models/Module.php::isCommentEnabled");
		$enabled = false;
        ...
        $log->debug("Exiting ./models/Module.php::isCommentEnabled");
		return $enabled;
	}
	...
	public function getFieldsByLabel() {
        global $log;
        $log->debug("Entering ./models/Module.php::getFieldsByLabel");
		$fields = $this->getFields();
		$fieldList = array();
		foreach($fields as $field) {
	...
	public function getNameFields(){
        ...
        $log->debug("Entering ./models/Module.php::getNameFields");
        ...
        $log->debug("Exiting ./models/Module.php::getNameFields");
	...
	public function getRecentRecords($limit=10) {
        ...
        $log->debug("Entering ./models/Module.php::getRecentRecords");
		$db = PearDatabase::getInstance();
        ...
        $log->debug("Exiting ./models/Module.php::getRecentRecords");
	...
	public function hasSequenceNumberField() {
        ...
        $log->debug("Entering ./models/Module.php::hasSequenceNumberField");
        if(!empty($this->fields)) {
            $fieldList = $this->getFields();
            foreach($fieldList as $fieldName => $fieldModel) {
        ...
        $log->debug("Exiting ./models/Module.php::hasSequenceNumberField");
        return false;
	}
	...
	public static function getAll($presence = array(), $restrictedModulesList = array()) {
        ...
        $log->debug("Entering ./models/Module.php::staticgetAll");
		$db = PearDatabase::getInstance();
        ...
        $log->debug("Exiting ./models/Module.php::staticgetAll");
		return $moduleModels;
	}
	...
	public static function getQuickCreateModules() {
        ...
        $log->debug("Entering ./models/Module.php::staticgetQuickCreateModules");
        ...
        $log->debug("Exiting ./models/Module.php::staticgetQuickCreateModules");
	...
	protected static function preModuleInitialize2() {
        ...
        $log->debug("Entering ./models/Module.php::staticpreModuleInitialize2");
        ...
        $log->debug("Exiting ./models/Module.php::staticpreModuleInitialize2");
	}
	...
	public function getDefaultCustomFilter() {
        global $log;
        $log->debug("Entering ./models/Module.php::getDefaultCustomFilter");
		$db = PearDatabase::getInstance();

		$result = $db->pquery("SELECT cvid FROM vtiger_customview WHERE setdefault = 1 AND entitytype = ?",
        array($this->getName()));
		if ($db->num_rows($result)) {
            $log->debug("Exiting ./models/Module.php::getDefaultCustomFilter");
	...
	public function getComments($pagingModel) {
        ...
        $log->debug("Entering ./models/Module.php::getComments");
		$comments = array();
		if(!$this->isCommentEnabled()) {
            $log->debug("Exiting ./models/Module.php::getComments");
			return $comments;
		}
	...
	function getCalendarActivities($mode, $pagingModel, $user, $recordId = false) {
        ...
        $log->debug("Entering ./models/Module.php::getCalendarActivities");
        ...
        $log->debug("Exiting ./models/Module.php::getCalendarActivities");
		return $activities;
	}
	...
	public function getSummaryViewFieldsList() {
		...
		if (!$this->summaryFields) {
			...
			foreach ($fields as $fieldName => $fieldModel) {
                $log->debug("VIEW_VIEW_FIELD:1:".($fieldModel->isSummaryField() ? "true" : "false"));
				if ($fieldModel->isSummaryField() && $fieldModel->isActiveField()) {
                    $log->debug("VIEW_VIEW_FIELD:2");					
	...
	public function getRelatedModuleRecordIds(Vtiger_Request $request, $recordIds = array()) {
        ...
        $log->debug("Entering ./models/Module.php::getRelatedModuleRecordIds");
		$db = PearDatabase::getInstance();
		...
		if(!empty($relatedModules)) {
            ...
            $log->debug("Exiting ./models/Module.php::getRelatedModuleRecordIds");
			return $relatedIds;
		} else {
            $log->debug("Exiting ./models/Module.php::getRelatedModuleRecordIds");
			return $relatedIds;
	...
	public function transferRecordsOwnership($transferOwnerId, $relatedModuleRecordIds){
        ...
        $log->debug("Entering ./models/Module.php::transferRecordsOwnership");
		$db = PearDatabase::getInstance();
        ...
        $log->debug("Exiting ./models/Module.php::transferRecordsOwnership");
	}
