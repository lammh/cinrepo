...
global $log;
$log->debug("Entering ./models/CssScript.php::getRel");
		$rel = $this->get('rel');
		if(empty($rel)){
...
global $log;
$log->debug("Entering ./models/CssScript.php::getMedia");
...
global $log;
$log->debug("Entering ./models/CssScript.php::getType");
		$type = $this->get('type');
		if(empty($type)){
...
global $log;
$log->debug("Entering ./models/CssScript.php::getHref");
		$href = $this->get('href');
		if(empty($href)) {
...
global $log;
$log->debug("Entering ./models/CssScript.php::staticgetInstanceFromLinkObject");
