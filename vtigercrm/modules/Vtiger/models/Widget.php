...
global $log;
$log->debug("Entering ./models/Widget.php::getWidth");
...
global $log;
$log->debug("Entering ./models/Widget.php::getHeight");
...
global $log;
$log->debug("Entering ./models/Widget.php::getPositionCol");
...
global $log;
$log->debug("Entering ./models/Widget.php::getPositionRow");
		$position = $this->get('position');
		if ($position) {
			$position = Zend_Json::decode(decode_html($position));
...
global $log;
$log->debug("Entering ./models/Widget.php::getUrl");
...
global $log;
$log->debug("Entering ./models/Widget.php::getTitle");
...
global $log;
$log->debug("Entering ./models/Widget.php::getName");
...
global $log;
$log->debug("Entering ./models/Widget.php::staticgetInstanceFromValues");
		$self = new self();
...
global $log;
$log->debug("Entering ./models/Widget.php::staticgetInstance");
...
global $log;
$log->debug("Entering ./models/Widget.php::staticupdateWidgetPosition");
...
global $log;
$log->debug("Entering ./models/Widget.php::staticgetInstanceWithWidgetId");
		$db = PearDatabase::getInstance();
		$result = $db->pquery('SELECT * FROM vtiger_module_dashboard_widgets
			INNER JOIN vtiger_links ON vtiger_links.linkid = vtiger_module_dashboard_widgets.linkid
...
global $log;
$log->debug("Entering ./models/Widget.php::add");
		$db = PearDatabase::getInstance();
...
global $log;
$log->debug("Entering ./models/Widget.php::remove");
		$db = PearDatabase::getInstance();
...
global $log;
$log->debug("Entering ./models/Widget.php::getDeleteUrl");
...
global $log;
$log->debug("Entering ./models/Widget.php::isDefault");
...
global $log;
$log->debug("Entering ./models/Widget.php::getDefaultWidgets");
		return array();
	}
}
