...
global $log;
$log->debug("Entering ./models/FindDuplicate.php::setModule");
...
global $log;
$log->debug("Entering ./models/FindDuplicate.php::getModule");
		return $this->module;
	}
...
global $log;
$log->debug("Entering ./models/FindDuplicate.php::getListViewHeaders");
...
global $log;
$log->debug("Entering ./models/FindDuplicate.php::getListViewEntries");
        $db = PearDatabase::getInstance();
        $moduleModel = $this->getModule();
...
global $log;
$log->debug("Entering ./models/FindDuplicate.php::getRecordCount");
		if($this->rows) {
			$rows = $this->rows;
		} else {
			$db = PearDatabase::getInstance();
