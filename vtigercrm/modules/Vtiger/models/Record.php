...
class Vtiger_Record_Model extends Vtiger_Base_Model {
	...
	public static function getSearchResult($searchKey, $module=false) {
        ...
        $log->debug("Entering ./models/Record.php::staticgetSearchResult");
        ...
        $log->debug("Exiting ./models/Record.php::staticgetSearchResult");
	...
	public function deleteImage($imageId) {
        ...
        $log->debug("Entering ./models/Record.php::deleteImage");
		$db = PearDatabase::getInstance();
		...
		if ($this->getId() === $crmId) {
            ...
            $log->debug("Exiting ./models/Record.php::deleteImage");
			return true;
		}
        $log->debug("Exiting ./models/Record.php::deleteImage");
		return false;
	...
	public function getDescriptionValue() {
        ...
        $log->debug("Entering ./models/Record.php::getDescriptionValue");
        ...
        $log->debug("Exiting ./models/Record.php::getDescriptionValue");
		return $description;
	}
