...
class Vtiger_RelationListView_Model extends Vtiger_Base_Model {
	...
	public function getEntries($pagingModel) {
        global $log;
        $log->debug("Entering ./models/RelationListView.php::getEntries");
        ...
        $log->debug("Exiting ./models/RelationListView.php::getEntries");
	...
	public function getRelatedEntriesCount() {
        global $log;
        $log->debug("Entering ./models/RelationListView.php::getRelatedEntriesCount");
		$db = PearDatabase::getInstance();
        ...
        $log->debug("Exiting ./models/RelationListView.php::getRelatedEntriesCount");
    ...
    public function getCurrencySymbol($recordId, $fieldModel) {
        global $log;
        $log->debug("Entering ./models/RelationListView.php::getCurrencySymbol");
        $db = PearDatabase::getInstance(); 
        ...
        if(($fieldName == 'currency_id') && ($moduleName == 'Products' || $moduleName == 'Services')) {
            ...
            $log->debug("Exiting ./models/RelationListView.php::getCurrencySymbol");
