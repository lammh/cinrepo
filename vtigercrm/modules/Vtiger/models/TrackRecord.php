...
global $log;
$log->debug("Entering ./models/TrackRecord.php::getId");
...
global $log;
$log->debug("Entering ./models/TrackRecord.php::getName");
...
global $log;
$log->debug("Entering ./models/TrackRecord.php::staticgetAll");
