...
global $log;
$log->debug("Entering ./models/TooltipView.php::setModule");
...
global $log;
$log->debug("Entering ./models/TooltipView.php::getFields");
		return $this->fields;
	}
...
global $log;
$log->debug("Entering ./models/TooltipView.php::loadRecord");
...
global $log;
$log->debug("Entering ./models/TooltipView.php::getStructure");
...
global $log;
$log->debug("Entering ./models/TooltipView.php::staticgetInstance");
