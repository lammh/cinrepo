...
global $log;
$log->debug("Entering ./models/RecordStructure.php::setRecord");
		$this->record = $record;
		return $this;
	}
...
global $log;
$log->debug("Entering ./models/RecordStructure.php::getRecord");
		return $this->record;
	}
...
global $log;
$log->debug("Entering ./models/RecordStructure.php::getRecordName");
...
global $log;
$log->debug("Entering ./models/RecordStructure.php::getModule");
		return $this->module;
	}
...
global $log;
$log->debug("Entering ./models/RecordStructure.php::setModule");
		$this->module = $module;
		return $this;
	}
...
global $log;
$log->debug("Entering ./models/RecordStructure.php::getStructure");
