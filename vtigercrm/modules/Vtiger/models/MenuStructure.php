...
global $log;
$log->debug("Entering ./models/MenuStructure.php::getTop");
...
global $log;
$log->debug("Entering ./models/MenuStructure.php::getMore");
...
global $log;
$log->debug("Entering ./models/MenuStructure.php::getLimit");
		return $this->limit;
	}
...
global $log;
$log->debug("Entering ./models/MenuStructure.php::getResponsiveMode");
...
global $log;
$log->debug("Entering ./models/MenuStructure.php::staticgetInstanceFromMenuList");
...
global $log;
$log->debug("Entering ./models/MenuStructure.php::staticsortMenuItemsByProcess");
		static $order = NULL;
		if ($order == NULL) {
			$order = array(
				'Campaigns',
...
global $log;
$log->debug("Entering ./models/MenuStructure.php::getEmptyMoreMenuList");
