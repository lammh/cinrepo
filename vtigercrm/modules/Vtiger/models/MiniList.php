...
global $log;
$log->debug("Entering ./models/MiniList.php::getTargetModule");
...
global $log;
$log->debug("Entering ./models/MiniList.php::getTargetFields");
...
global $log;
$log->debug("Entering ./models/MiniList.php::getTargetModuleModel");
...
global $log;
$log->debug("Entering ./models/MiniList.php::initListViewController");
...
global $log;
$log->debug("Entering ./models/MiniList.php::getTitle");
...
global $log;
$log->debug("Entering ./models/MiniList.php::getHeaders");
		$this->initListViewController();
...
global $log;
$log->debug("Entering ./models/MiniList.php::getHeaderCount");
...
global $log;
$log->debug("Entering ./models/MiniList.php::getRecordLimit");
		return 10;
	}
...
global $log;
$log->debug("Entering ./models/MiniList.php::getRecords");
