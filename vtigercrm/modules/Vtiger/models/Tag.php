...
global $log;
$log->debug("Entering ./models/Tag.php::__construct");
...
global $log;
$log->debug("Entering ./models/Tag.php::save");
...
global $log;
$log->debug("Entering ./models/Tag.php::delete");
...
global $log;
$log->debug("Entering ./models/Tag.php::staticgetAll");
		$tag = new self();
...
global $log;
$log->debug("Entering ./models/Tag.php::staticgetTaggedRecords");
		$recordModels = array();
		if(!empty($tagId)) {
			$db = PearDatabase::getInstance();
