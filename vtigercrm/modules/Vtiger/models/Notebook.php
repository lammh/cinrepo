...
global $log;
$log->debug("Entering ./models/Notebook.php::getContent");
...
global $log;
$log->debug("Entering ./models/Notebook.php::save");
...
global $log;
$log->debug("Entering ./models/Notebook.php::staticgetUserInstance");
