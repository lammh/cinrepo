...
global $log;
$log->debug("Entering ./layout_utils.php::get_left_form_footer");
...
global $log;
$log->debug("Entering ./layout_utils.php::get_form_footer");
...
global $log;
$log->debug("Entering ./layout_utils.php::get_module_title");
global $image_path;
global $app_strings;
