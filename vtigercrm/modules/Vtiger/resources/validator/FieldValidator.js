...
/** ▼ ** 151021 大熊追加 *****************************************************/
Vtiger_PositiveNumber_Validator_Js("Vtiger_OrMoreZero_Validator_Js",{
	...
	invokeValidation: function(field, rules, i, options){
		...
		var OrMoreZero_Validator_Js = new Vtiger_OrMoreZero_Validator_Js();
		OrMoreZero_Validator_Js.setElement(field);
		var response = OrMoreZero_Validator_Js.validate();
		if(response != true){
			return OrMoreZero_Validator_Js.getError();
		}
	}
