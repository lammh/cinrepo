<?php /* Smarty version Smarty-3.1.7, created on 2015-12-22 04:44:39
         compiled from "/var/www/html/vtigercrm/includes/runtime/../../layouts/vlayout/modules/SalesOrder/DetailViewHeader.tpl" */ ?>
<?php /*%%SmartyHeaderCode:10341943945678d537a2f3c2-72051222%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c224e477b4a38f7b26edbe2c47b80151e407a3e2' => 
    array (
      0 => '/var/www/html/vtigercrm/includes/runtime/../../layouts/vlayout/modules/SalesOrder/DetailViewHeader.tpl',
      1 => 1450267291,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '10341943945678d537a2f3c2-72051222',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5678d537b87a7',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5678d537b87a7')) {function content_5678d537b87a7($_smarty_tpl) {?>
...
</div></div><font size="4"><b>[<?php echo $_smarty_tpl->tpl_vars['RECORD']->value->get("carrier");?>
]<?php echo $_smarty_tpl->tpl_vars['RECORD']->value->get("sostatus");?>
</b></font><div class="span7"><div class="pull-right detailViewButtoncontainer"><div class="btn-toolbar"><?php if (substr($_smarty_tpl->tpl_vars['RECORD']->value->get("sostatus"),0,1)!="2"){?><?php  $_smarty_tpl->tpl_vars['DETAIL_VIEW_BASIC_LINK'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['DETAIL_VIEW_BASIC_LINK']->_loop = false;
...
</strong></button></span><?php } ?><?php }?><?php if (count($_smarty_tpl->tpl_vars['DETAILVIEW_LINKS']->value['DETAILVIEW'])>0){?><span class="btn-group"><button class="btn dropdown-toggle" data-toggle="dropdown" href="javascript:void(0);"><strong><?php echo vtranslate('LBL_MORE',$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
