...
<?php /*%%SmartyHeaderCode:14738776055678d370d55521-59155148%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '14738776055678d370d55521-59155148',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5678d370e5d75',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5678d370e5d75')) {function content_5678d370e5d75($_smarty_tpl) {?>
...
?><?php if ($_smarty_tpl->tpl_vars['LISTVIEW_SETTING']->value!=null){?><li><a href=<?php echo $_smarty_tpl->tpl_vars['LISTVIEW_SETTING']->value->getUrl();?>
><?php echo vtranslate($_smarty_tpl->tpl_vars['LISTVIEW_SETTING']->value->getLabel(),$_smarty_tpl->tpl_vars['MODULE']->value);?>
</a></li><?php }?><?php } ?></ul></span></div><?php }?></div><div class="clearfix"></div><input type="hidden" id="recordsCount" value=""/><input type="hidden" id="selectedIds" name="selectedIds" /><input type="hidden" id="excludedIds" name="excludedIds" /><?php }} ?>