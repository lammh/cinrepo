...
<?php /*%%SmartyHeaderCode:16437033225678d37f1b3288-82478218%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '16437033225678d37f1b3288-82478218',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5678d37f2d5c6',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5678d37f2d5c6')) {function content_5678d37f2d5c6($_smarty_tpl) {?>
...
?><?php if ($_smarty_tpl->tpl_vars['DETAIL_VIEW_BASIC_LINK']->value!=null){?><span class="btn-group"><button class="btn" id="<?php echo $_smarty_tpl->tpl_vars['MODULE_NAME']->value;?>
...
?><?php if ($_smarty_tpl->tpl_vars['DETAIL_VIEW_LINK']->value!=null){?><?php if ($_smarty_tpl->tpl_vars['DETAIL_VIEW_LINK']->value->getLabel()==''){?><li class="divider"></li><?php }else{ ?><li id="<?php echo $_smarty_tpl->tpl_vars['MODULE_NAME']->value;?>
...
</a></li><?php }?><?php }?><?php } ?></ul></span><?php }?><?php if (count($_smarty_tpl->tpl_vars['DETAILVIEW_LINKS']->value['DETAILVIEWSETTING'])>0){?><span class="btn-group"><button class="btn dropdown-toggle" href="#" data-toggle="dropdown"><i class="icon-wrench" alt="<?php echo vtranslate('LBL_SETTINGS',$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
