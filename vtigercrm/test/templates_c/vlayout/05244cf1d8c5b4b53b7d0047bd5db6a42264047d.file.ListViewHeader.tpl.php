<?php /* Smarty version Smarty-3.1.7, created on 2015-12-22 04:37:04
         compiled from "/var/www/html/vtigercrm/includes/runtime/../../layouts/vlayout/modules/Vtiger/ListViewHeader.tpl" */ ?>
<?php /*%%SmartyHeaderCode:17621991055678d370b2ef90-48848339%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '17621991055678d370b2ef90-48848339',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5678d370d33e0',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5678d370d33e0')) {function content_5678d370d33e0($_smarty_tpl) {?>
...
?><?php if ($_smarty_tpl->tpl_vars['LISTVIEW_MASSACTION']->value!=null){?><li id="<?php echo $_smarty_tpl->tpl_vars['MODULE']->value;?>
...
</a></li><?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['actionCount']['last']==true){?><li class="divider"></li><?php }?><?php }?><?php } ?><?php if (count($_smarty_tpl->tpl_vars['LISTVIEW_LINKS']->value['LISTVIEW'])>0){?><?php  $_smarty_tpl->tpl_vars['LISTVIEW_ADVANCEDACTIONS'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['LISTVIEW_ADVANCEDACTIONS']->_loop = false;
...
?><?php if ($_smarty_tpl->tpl_vars['LISTVIEW_ADVANCEDACTIONS']->value!=null){?><li id="<?php echo $_smarty_tpl->tpl_vars['MODULE']->value;?>
...
</a></li><?php }?><?php } ?><?php }?></ul><?php }?></span><?php  $_smarty_tpl->tpl_vars['LISTVIEW_BASICACTION'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['LISTVIEW_BASICACTION']->_loop = false;
...
?><?php if ($_smarty_tpl->tpl_vars['LISTVIEW_BASICACTION']->value!=null){?><span class="btn-group"><button id="<?php echo $_smarty_tpl->tpl_vars['MODULE']->value;?>
...
?><?php if ($_smarty_tpl->tpl_vars['CUSTOM_VIEW']->value!=null){?><option  data-editurl="<?php echo $_smarty_tpl->tpl_vars['CUSTOM_VIEW']->value->getEditUrl();?>
...
<?php }?><?php if ($_smarty_tpl->tpl_vars['GROUP_LABEL']->value!='Mine'){?> [ <?php echo $_smarty_tpl->tpl_vars['CUSTOM_VIEW']->value->getOwnerName();?>
 ]  <?php }?></option><?php }?><?php } ?></optgroup><?php } ?><?php if ($_smarty_tpl->tpl_vars['FOLDERS']->value!=''){?><optgroup id="foldersBlock" label='<?php echo vtranslate('LBL_FOLDERS',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
?><?php if ($_smarty_tpl->tpl_vars['FOLDER']->value!=null){?><option data-foldername="<?php echo $_smarty_tpl->tpl_vars['FOLDER']->value->getName();?>
...
</option><?php }?><?php } ?></optgroup><?php }?></select><span class="filterActionsDiv hide"><hr><ul class="filterActions"><li data-value="create" id="createFilter" data-createurl="<?php echo $_smarty_tpl->tpl_vars['CUSTOM_VIEW']->value->getCreateUrl();?>
