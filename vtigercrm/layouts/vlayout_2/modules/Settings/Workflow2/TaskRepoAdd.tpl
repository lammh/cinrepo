        ...
        <div style="padding: 10px;">{* Content Start *}
            <table cellpadding="0" cellspacing="0">
                ...
                <tr style="display:none;" id="licenseColumn">
                    <td class='dvtCellLabel' style="width:200px;">{vtranslate('LBL_REPO_LICENSEKEY','Settings:Workflow2')}</td>
                    <td class='dvtCellInfo'><input type="text" name="repo_license" value="" style="width:300px;"></td>
                </tr>
            </table>
        </div> {* Content Ende *}
