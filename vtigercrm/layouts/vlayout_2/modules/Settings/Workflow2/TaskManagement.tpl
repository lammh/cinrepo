                ...
                <td>
                    ...
                    {else}
                        {if $task.prevent === false}
                            <a href="#" alt="Redownload" title="Redownload" onclick="installUpdate({$task.id});">no</a>
...
<div style="margin: 10px 0 0 0; width: 750px">
    <button class="btn addButton" onclick="createManualType();">{vtranslate('LBL_CREATE_TYPE','Settings:Workflow2')}</button>
</div>
