...
{strip}
	...
	{assign var=ACCESSIBLE_GROUP_LIST value=$USER_MODEL->getAccessibleGroupForModule($MODULE)}
	  ...
	  <select class="select2 listSearchContributor span10 {$ASSIGNED_USER_ID}"  name="{$ASSIGNED_USER_ID}" multiple style="width:150px;"data-fieldinfo='{$FIELD_INFO|escape}' disabled>
