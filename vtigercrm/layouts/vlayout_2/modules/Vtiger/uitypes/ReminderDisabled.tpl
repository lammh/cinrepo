...
<div>
	...
	<div style="float:left" class="{if $REMINDER_VALUES neq ''}show{else}hide{/if}">
		<div style="float:left">
			<div style="float:left">
				<select class="chzn-select input-mini" name="remdays" disabled>
					{for $DAYS = 0 to 31}
		...
		<div style="float:left">
			<div style="float:left">
				<select class="chzn-select input-mini" name="remhrs" disabled>
					{for $HOURS = 0 to 23}
		...
		<div style="float:left">
			<div style="float:left">
				<select class="chzn-select  input-mini" name="remmin" disabled>
				{for $MINUTES = 1 to 59}
