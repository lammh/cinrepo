	...
	<div class="{if $RECURRING_INFORMATION['recurringcheck'] eq 'Yes'}show{else}hide{/if} span" id="repeatUI" style="width:90%;">
		<div class="row-fluid">
			<span class="span" style="width:150px;">
				...
				<select class="select2 input-mini" name="repeat_frequency" disabled>
			...
			<span class="span">
				<select class="select2 input-medium" style="width:100px;" name="recurringtype" id="recurringType" disabled>
		...
		<div class="{if $RECURRING_INFORMATION['eventrecurringtype'] eq 'Monthly'}show{else}hide{/if}" id="repeatMonthUI" style="margin-top:10px;"RCa>
			...
			<div class="row-fluid" id="repeatMonthDayUI" style="margin-top: 10px;">
				...
				<span class="span3">
					<select id="repeatMonthDayType" class="select2 input-small" name="repeatMonth_daytype" disabled>
				...
				<span class="span5 margin0px">
					<select id="repeatMonthDay" class="select2 input-medium" name="repeatMonth_day" disabled>
