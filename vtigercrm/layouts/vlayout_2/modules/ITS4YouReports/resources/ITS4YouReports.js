...
function setModuleFields(availModules, mode) {
    ...
    var actionParams = {
        "type": "POST",
        "url": 'index.php?module=ITS4YouReports&action=IndexAjax&primarymoduleid='+primarymodule,
        "dataType": "html",
        "data": postData
    };
...
function exportToPDF(report_filename){
    ...
    var reports4you_name = jQuery('.rpt4youTableText').html();
    ...
    if (document.getElementById("reports4you_widget_"+id) != null){
        var ch_image_name = jQuery('#ch_image_name').val();
