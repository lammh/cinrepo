        ...
        <table class="table table-striped table-bordered profilesEditView">
            <thead>
                <tr class="blockHeader">
                    ...
                    <th style="border-left: 1px solid #DDD !important;" width="15%" align="center" class="hide">{vtranslate('LBL_EXPORT_TO_RTF','PDFMaker')}</th>
                </tr>
            </thead>
            <tbody>
            {foreach item=arr from=$PERMISSIONS}
                {foreach key=profile_name item=profile_arr from=$arr}
                    <tr>
                        ...
                        <td class="cellText hide" align="center">
                            {if $MODE eq "edit"}
