...
<div style="height:1024px;width:100%;position:relative;" id="mainWfContainer">
    <div style="position:absolute;width:100%;z-index:1000;" id='workflowObjectsContainer'>
        {$WorkflowObjectHTML}
    </div>
        ...
        {$html}
			...
			<div id="workflowDesignContainer" class="workflowDesignContainer" style="{if $workflowData.module_name eq ""}display:none;{/if}">
