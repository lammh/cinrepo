		...
		<div class="row-fluid detailViewTitle">
			<div class="{if $NO_PAGINATION} span12 {else} span10 {/if}">
				<div class="row-fluid">
					...
					{*ステータス表示ーーーーーーーーーーーーー▼*}
					<font size="4"><b>[{$RECORD->get("carrier")}]{$RECORD->get("sostatus")}</b></font>
					{*ステータス表示ーーーーーーーーーーーーー▲*}
					...
					<div class="span7">
						...
						<div class="pull-right detailViewButtoncontainer">
							...
							{*ステータスが承認済みだったら編集出来ないようにするーーーーーーーーーーーーー▼*}
							{if substr($RECORD->get("sostatus"),0,1) neq "2"}
