...
{strip}
	...
	<td>
		<input id="{$qty}" name="{$qty}" type="text" class="qty smallInputBox" data-validation-engine="validate[required,funcCall[Vtiger_OrMoreZero_Validator_Js.invokeValidation]]" value="{if !empty($data.$qty)||$data.$qty==='0'}{$data.$qty}{else}1{/if}"/>
