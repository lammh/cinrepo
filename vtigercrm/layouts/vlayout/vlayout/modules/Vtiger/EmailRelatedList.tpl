          ...
          {if $RELATED_LINK ne null}
            <div class="btn-group">
              ...
              <button type="button" class="btn [addButton
                      ...
                      {/if}
                      {if $IS_SELECT_BUTTON neq true}name="composeEmail"{/if}>
          ...
          <span class="pageNumbers">
            <span class="pageNumbersText">
              {if !empty($RELATED_RECORDS)} 
                {$PAGING->getRecordStartRange()}
                {vtranslate('LBL_to', $RELATED_MODULE_NAME)}
